                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex gap-2">
                                {["L", "XL", "XS"].map((size) => (
                                    <button
                                        key={size}
                                        className="w-8 h-8 border rounded-lg hover:border-black flex items-center justify-center text-sm"
                                    >
                                        {size}
                                    </button>
                                ))}
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex gap-2">
                                <button className="w-6 h-6 rounded-full bg-blue-600 border-2 border-gray-300" />
                        ...
                        <div className="flex gap-4 items-center">
                            ...
                            <button className="px-8 py-3 bg-[#B88E2F] text-white rounded-lg hover:bg-[#A47E2A] transition-colors">
                                Add To Cart
                            </button>
                        </div>
                    </div>
